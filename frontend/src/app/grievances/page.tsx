          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="min-w-0">
                <h1 className="text-lg sm:text-2xl font-bold text-white tracking-tight truncate">Active Grievances</h1>
                <p className="text-xs sm:text-sm text-white/80 mt-0.5 truncate">Manage pending & in-progress grievances</p>
              </div>
            </div>
            <div className="flex flex-wrap items-center gap-2 sm:gap-4">
              ...
              <Link 
                ...
                className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-emerald-500 text-white rounded-xl hover:bg-emerald-600 transition-all shadow-lg text-sm"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7 gap-3">
            ...
            <div className="relative col-span-1 sm:col-span-2 lg:col-span-2">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2.5 text-sm border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white/50"
              />
            </div>
            ...
            <select
              ...
              className="text-sm border border-gray-300 rounded-xl px-3 py-2.5 focus:ring-2 focus:ring-blue-500 bg-white/50 cursor-pointer"
            >
            ...
            <button
              ...
              className="px-4 py-2.5 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition-all flex items-center justify-center font-medium sm:col-span-2 lg:col-span-1"
            >
